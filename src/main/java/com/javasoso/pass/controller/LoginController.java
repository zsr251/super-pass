...
public class LoginController extends BaseController {
    ...
    public ResultModel loginByPassword(HttpServletRequest request, @RequestHeader("client") Integer client, @Valid @RequestBody LoginVO loginVO) {
    ...
    @CheckLogin
    public ResultModel logout(@RequestHeader("token") String token, @RequestHeader("client") Integer client) {
